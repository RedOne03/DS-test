...
void main() {
  group('PsychoAI Tests', () {
    testWidgets('Mensaje de bienvenida', (WidgetTester tester) async {
    ...
    testWidgets('Disclaimer presente', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: SimplePsychoAiScreen()));
      expect(find.textContaining('Este asistente es solo para apoyo'),
          findsOneWidget);
    });

    testWidgets('UI básica presente', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: SimplePsychoAiScreen()));
      expect(find.byType(TextField), findsOneWidget);
      expect(find.byIcon(Icons.send), findsOneWidget);
    });

    testWidgets('Escribir en campo de texto', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: SimplePsychoAiScreen()));
      await tester.enterText(find.byType(TextField), 'Test');
      expect(find.text('Test'), findsOneWidget);
    });

    testWidgets('Envío de mensaje y carga', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: SimplePsychoAiScreen()));
      ...
      // Esperar a que termine el Future.delayed
      await tester.pump(const Duration(milliseconds: 600));
    });

    testWidgets('Campo se limpia después de enviar',
      ...
      // Esperar a que termine el Future.delayed para evitar timer pendiente
      await tester.pump(const Duration(milliseconds: 600));
    });

    testWidgets('Limpiar chat', (WidgetTester tester) async {
      await tester.pumpWidget(const MaterialApp(home: SimplePsychoAiScreen()));
